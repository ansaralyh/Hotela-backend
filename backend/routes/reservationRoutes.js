...
const { store, index ,get, update, destroy, checkAvailability, getReservationsForDropdown, addItemstoReservationInvoice, addPayment} = require('../controllers/reservationController');
...
router.post('/payment/:reservationId',auth,isAuthorizedRole(['owner','receptionist']),addPayment)
